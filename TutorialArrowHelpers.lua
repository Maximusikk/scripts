-- ModuleScript: TutorialArrowHelpers
-- Shared arrow helpers for tutorial GUI/world arrows.

local ArrowHelpers = {}

function ArrowHelpers.new(context)
	...
	local ARROW_ROT_OFFSET = context.ARROW_ROT_OFFSET
