...
function InventoryTracker.new(options)
	local inventoryFolder = options.inventoryFolder
	local runService = options.runService
	local onGuideRobot = options.onGuideRobot
	...
	return {
		...
		setLastHatchedUuid = function(uuid: string?)
